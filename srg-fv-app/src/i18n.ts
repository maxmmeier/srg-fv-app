    ...
    resources: {
      de: {
        translation: {
          ...
          "signatureMemberOrParent" : "Unterschrift Mitglied / Erziehungsberechtigte/r",
          "Sepa" : "SEPA Lastschriftmandat",
          "SepaIntro" : "Ich ermächtige den Förderverein der Schiedsrichter-Gruppe Stuttgart e. V. den Mitgliedsbeitrag von meinem Konto mittels Lastschrift einzuziehen. Zugleich weise ich mein Kreditinstitut an, die von dem Förderverein der Schiedsrichter-Gruppe Stuttgart e. V. auf mein Konto gezogenen Lastschriften einzulösen.",
          "SepaNotice" : "Hinweis: Ich kann innerhalb von acht Wochen, beginnend mit dem Belastungsdatum, die Erstattung des belasteten Betrages verlangen. Es gelten dabei die mit meinem Kreditinstitut vereinbarten Bedingungen.",
